         ...
         begin
            case (state) // state and data transfers
				 ...
				 CACS1:		// ** TODO #3 **  Complete State transitions. RTL operations are already completed.
					begin
						// State transitions in the CU
						if ((As_of_I < Cs_of_K) && (I != 3))
							state <= CAB;
						else if ((As_of_I < Cs_of_K) && (I == 3))
							state <= CBCS2;
						else if ((As_of_I >= Cs_of_K) && (K == 3))
							state <= CABS2;
						else
							state <= CACS1;
				 ...
				 CBCS1:		// ** TODO #4 **  Complete State transitions. RTL operations are already completed.
					begin
						// State transitions in the CU
						if ((Bs_of_J < Cs_of_K) && (J != 3))
							state <= CAB;
						else if ((Bs_of_J < Cs_of_K) && (J == 3))
							state <= CACS2;
						else if ((Bs_of_J >= Cs_of_K) && (K == 3))
							state <= CABS2;
						else
							state <= CBCS1;
				...
				CBCS2:		// ** TODO #5 **  Complete State transitions. RTL operations are already completed.
					begin
						// State transitions in the CU
						if ((K == 3) && (Bs_of_J >= Cs_of_K))
							state <= RB;
						else if ((J == 3) && (Bs_of_J < Cs_of_K))
							 state <= RC;
						else
							state <= CBCS2;
				...
				CABS2:		// ** TODO #6 **  Complete State transitions. RTL operations are already completed.
					begin
						// State transitions in the CU
						if ((I == 3) && (As_of_I < Bs_of_J))
							state <= RB;
						else if ((J == 3) && (As_of_I >= Bs_of_J))
							 state <= RA;
						else
							state <= CABS2;
				...
				CACS2:		// ** TODO #7 **  Complete State transitions. RTL operations are already completed.
					begin
						// State transitions in the CU
						if ((K == 3) && (As_of_I >= Cs_of_K))
							state <= RA;
						else if ((I == 3) && (As_of_I < Cs_of_K))
							 state <= RC;
						else
							state <= CACS2;
